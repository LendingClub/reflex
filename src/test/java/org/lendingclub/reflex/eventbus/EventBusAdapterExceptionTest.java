...
public class EventBusAdapterExceptionTest {
  ...
  public void testIt() throws InterruptedException {
    ...
    x.subscribe(
        c -> {
          // This subscriber is going to blow up its monad/subscription.  That is just how
    ...
    x.subscribe(
        z -> {
          ...
          // This subscription should *NOT FAIL*....the fact that the other subscriber blew up
          // should not impact us here.
          latch.countDown();
          Thread.sleep(50);
          ;
