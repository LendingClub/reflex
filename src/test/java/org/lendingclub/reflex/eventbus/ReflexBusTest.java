...
public class ReflexBusTest {
	...
	public void testObservableWithReflexExecutorWithMultipleThreads() throws InterruptedException {
		testObservableWithExecutor(ReflexExecutors.newThreadPoolExecutorBuilder().withThreadPoolSize(2).build(),5);
	}
	...
	@Test
	public void testConcurrentSubscriberWithReflexExecutorWithMultipleThreads() throws InterruptedException {
		testConcurrentSubscriberWithExecutor(ReflexExecutors.newThreadPoolExecutorBuilder().withThreadPoolSize(3).build(),20);
	}
	

	public void testConcurrentSubscriberWithExecutor(Executor executor, int count) throws InterruptedException {
		logger.info("\n\n");
		...
		bus.createConcurrentSubscriber().withExecutor(executor).subscribe(event -> {
	...
	public void testObservableWithExecutor(Executor executor, int count) throws InterruptedException {
		...
		bus.createObservable().subscribe(x -> {
