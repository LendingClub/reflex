...
public class ReflexMetrics {
  ...
  public ReflexMetrics monitor(ThreadPoolExecutor tpe, String name) {
    ...
    Preconditions.checkState(
        registry != null, "MetricRegistry not set.  Please call withMetricRegistry() first");
    Gauge<Integer> activeCountGauge =
        new Gauge<Integer>() {
    ...
    Gauge<Long> completedTaskCountGauge =
        new Gauge<Long>() {
    ...
    Gauge<Integer> queueRemainingCapcity =
        new Gauge<Integer>() {
          @Override
          public Integer getValue() {
  ...
  public ReflexMetrics monitor(SQSAdapter adapter, String name) {
    ...
    registerGauge(name, "totalFailure", adapter.getTotalFailureCount());
